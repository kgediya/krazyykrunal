...
var redirection_links = ["www.instagram.com/krazyykrunal","www.instagram.com/xdgmumbai","www.instagram.com/jeetesh_singh_09"];
var current_index = 0;
class ScrollPos {
	constructor() {
		this.acceleration = 0;
...
function init(textures) {
	...
	function draw() {
		...
		current_index = scrollTarget/scrollPerImage
